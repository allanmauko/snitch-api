   ...
   After that, I bought a refurbished iPhone SE with 64GB of storage for $165. I eventually stopped using this one, because the camera was so bad that it was upsetting my friends. Also, a small part of the screen stopped working—right in the spot I had to press to switch the keyboard from letters to numbers, which meant I had no access to punctuation and came off, via text, as very cold. And I couldn’t log in to my bank account.",category_id:2,author_id:2, comment_id:1,like_id:1,bookmark_id:1,date_posted:"15th sep 2022")  
    ...
    Netflix's strength is binge-watching, which means it's good for catching up on TV shows just before the next season begins airing. That's why most of Netflix's library is about one year old. Networks aren't willing to let Netflix load up its library with recent content.",category_id:5,author_id:2, comment_id:5,like_id:5,bookmark_id:5,date_posted:"1st dec 2020")  
