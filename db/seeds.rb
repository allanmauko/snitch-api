...
Article.create(title:"Don’t Trash Your Old Phone—Give It a Second Life",content:"The original iPhone SE is a great little phone, and I love it. It has a headphone jack—remember those? It fits in a butt pocket. It was announced in the Obama era.Sure, the first one I owned, which I purchased in 2017, had only 16GB of storage. And yes, I was forced to stop using it after a terrifying incident in which it refused to update to the latest iOS, even after I deleted nearly everything on it, which prevented me from installing the Ticketmaster app that I needed to enter a Harry Styles concert that I had flown to California by myself to attend. (Would you believe someone at the arena simply agreed to print the ticket out? I was crying.",category_id:1,author_id:1, number_of_likes:1, image_url:"https://c.tadst.com/gfx/750x500/authors-day-fun.jpg")
 ...
 Netflix's strength is binge-watching, which means it's good for catching up on TV shows just before the next season begins airing. That's why most of Netflix's library is about one year old. Networks aren't willing to let Netflix load up its library with recent content.",category_id:1,author_id:1, number_of_likes:1, image_url:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiSmkKDBpOtbeZDyr6ud0i9JurzE9jAA1Y5Q&usqp=CAU")  
